...
const OVERSEAS: Case[] = [
  ...
  // ★국가명 없이 **도시명만** 적힌 옛 명식(출생지 피커 이전에 손으로 타이핑한 것)
  { name: '밀라노(도시명만) 1995-08-06 16:00', dt: '1995-08-06 16:00', place: '밀라노', lon: 9.19,
    utc: 120, dst: true, guards: '★국가명이 없어도 도시명으로 나라를 찾는다 — 못 찾으면 여름 60분이 통째로 빠진다' },
  { name: '파리(도시명만) 2000-07-01 12:00', dt: '2000-07-01 12:00', place: '파리', lon: 2.35,
    utc: 120, dst: true, guards: '〃 — 경도만 보면 UTC+0 이 된다' },
];
