 ...
 *
 * 실측 근거(2026-08-19 · `api_usage` kind='coach' n=13 → in 1,394 · out 415 tok, Haiku 단가)
 *   C1 규칙블록 미탑재  : 실으면 10턴 ₩52 → ₩261 (5.0배)
 *   C2 캐시 breakpoint  : 없으면 턴당 ₩8.8 (있으면 ₩4.2)
 *   C3 1시간 TTL        : 5분이면 흩어진 10턴 ₩103 (1h 는 ₩52)
 *   C4 max_tokens 상한  : 출력이 턴 원가의 76%
