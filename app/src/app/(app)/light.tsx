          ...
          <>
            ...
            <View style={styles.resCard}>
              ...
              <View style={styles.personaRow}>
                ...
                <View style={{ flex: 1 }}>
                  <Text style={[styles.resName, { fontSize: fs(19), lineHeight: 26 }]}>{result.persona.name}</Text>
              ...
              <Text style={[styles.body, { fontSize: fs(14), lineHeight: 22 }]}>{result.persona.summary}</Text>
            ...
            {result.ilju ? (
              <View style={styles.resCard}>
                ...
                <Text style={[styles.body, { fontSize: fs(14), lineHeight: 22 }]}>{result.ilju.trait.personality}</Text>
              </View>
            ) : null}
