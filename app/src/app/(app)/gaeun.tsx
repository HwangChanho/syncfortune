  ...
  async function onStart() {
    ...
    try {
      ...
      if (!admin) {
        ...
        const g = await ensureCoinsFor('gaeun', { title: t('gaeun.title', '맞춤 개운법'), t, goCharge: () => router.push('/coins'), chartId });
      ...
      <ScrollView style={styles.overlay} contentContainerStyle={styles.wrap}>
        ...
        {reading?.error ? (
          ...
          <View style={[styles.card, styles.gate]}>
            ...
            <PressableScale style={styles.cta} onPress={onStart}><Text style={styles.ctaTx}>{t('special.unlock', 'woon으로 열기')}</Text></PressableScale>
