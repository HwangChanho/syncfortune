...
type LifeData = { summary: string; decades: Decade[]; yongsin?: string; peak?: string; caution?: string; advice?: string; headline?: string; base?: string }; // base: JSON 파싱 폴백 프로즈(구조화 실패 시)
  ...
  async function doStart() {
    ...
    try {
      ...
      if (!admin) {
        ...
        const g = await ensureCoinsFor('lifegraph', { title: t('life.gateTitle', '인생 그래프'), t, goCharge: () => router.push('/coins'), chartId });
        logEvent('lifegraph_coin_gate', { result: g });
