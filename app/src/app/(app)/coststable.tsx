...
const ROWS: Row[] = [
  ...
  { name: '직업 딥리포트', kind: 'jobfit', mult: 1, type: '유료', api: true, price: priceOf('jobfit'), adEst: 0 },
  { name: '재물 딥리포트', kind: 'wealth', mult: 1, type: '유료', api: true, price: priceOf('wealth'), adEst: 0 },
];
