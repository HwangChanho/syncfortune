...
export function ReadingScreen({
  ...
  // 관리자 전용(07-21 코드큐) — 이 카테고리 풀이를 초기화(삭제)해 다음 생성에서 새로 만들게 한다.
...
const styles = StyleSheet.create({
  ...
  adminResetBtn: { marginTop: space(3), borderWidth: 1, borderColor: '#E5484D', borderStyle: 'dashed', borderRadius: radius.md, paddingVertical: space(2.5), alignItems: 'center' }, // 관리자 초기화(위험 톤·점선)
  adminResetBtnTx: { color: '#E5484D', fontSize: 13, fontWeight: '800' },
