  ...
  return (
    <PressableScale style={styles.card} onPress={() => router.push(meta.route as any)}>
      ...
      <View style={styles.inner}>
        ...
        <Text style={[styles.title, { fontSize: fs(22), lineHeight: Math.round(fs(22) * 1.3) }]} numberOfLines={2}>{label}</Text>
        <Text style={[styles.reason, { fontSize: fs(13), lineHeight: Math.round(fs(13) * 1.5) }]} numberOfLines={2}>{step.reason}</Text>
