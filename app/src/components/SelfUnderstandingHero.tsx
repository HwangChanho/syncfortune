...
const styles = StyleSheet.create({
  ...
  // 명식 없음(등록 유도)
  emptyCard: { backgroundColor: colors.card, borderRadius: radius.lg, borderWidth: 1.5, borderColor: colors.ju, borderStyle: 'dashed', padding: space(5), alignItems: 'center', marginBottom: space(4), ...shadow.card },
