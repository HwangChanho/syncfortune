...
export const SECTIONS: Section[] = [
  ...
  { key: 'premium', titleKey: 'menu.secPremium', descKey: 'menu.secPremiumDesc', items: [
    ...
    { key: 'timeline', labelKey: 'menu.timeline', descKey: 'menu.timelineDesc', image: A('icons/timeline.jpg'), route: '/timeline', ready: true, premium: true, creditKey: 'timeline' }, // 연도별 인생 타임라인 = 프리미엄 4종(사주·자미·궁합·타임라인) — 홈 리스트 누락 수정(daniel 07-02)
