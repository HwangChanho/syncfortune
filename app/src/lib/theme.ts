...
export const colors = {
  ...
  glass: 'rgba(34, 31, 68, 0.7)', // 글래스모피즘용 반투명 바탕
  glassLight: 'rgba(237, 231, 214, 0.1)', // 밝은 글래스 요소
  // 텍스트·선 (밝은 — 남색 배경 가독)
...
export const gradients = {
  gold: ['#EBCF8A', '#C9A14A', '#A8843A'], // 메탈릭 골드
  midnight: ['#221F44', '#15132E'],         // 깊은 밤하늘
  glass: ['rgba(255,255,255,0.12)', 'rgba(255,255,255,0.03)'], // 글래스 반사광
} as const;
