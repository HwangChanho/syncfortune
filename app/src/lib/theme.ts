 ...
 * ★되돌리려면 이 한 줄만 바꾸면 된다.
 */
const EP = CAMEL;   // ★2026-09-02 **롤백**(Boss *"롤백해"*) — 브랜드 파랑 → 카멜로 되돌림.
//   ⚠️`BRAND` 팔레트는 지우지 않고 남겨 둔다 — 다시 하자고 하면 이 한 줄만 바꾸면 된다.
//   ★로고·아이콘 자체 색(`#1B5FE0`)은 **그대로**다(09-01 결정) — 바뀐 것은 앱 «내부» 색뿐이다.
