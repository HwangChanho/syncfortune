...
const ko = {
  ...
  menu: {
    ...
    premium: '깊은 풀이', premiumDesc: '딥 통변·전 영역', premiumTag: '코인',
  ...
  reading: {
    ...
    askPremiumCta: '코인으로 더 물어보기', askPayTitle: '추가 질문', askPayMsg: '무료 질문을 다 쓰셨어요. 건당 {{price}}으로 더 물어보시겠어요?',
  ...
  compat: {
    ...
    premiumTitle: '궁합 풀이', premiumMsg: '관계마다 따로 풀어 드려요. 코인으로 열 수 있어요.',
  ...
  today: {
    ...
    more: '분야별로 자세히 보기 →',
    genFail: '풀이 생성에 실패했어요. 잠시 후 다시 시도해 주세요.', title: '오늘의 운세', heroSub: '오늘 일진으로 보는 하루 흐름', generating: '오늘의 흐름을 풀어내는 중…', gateTitle: '오늘의 운세 보기', gateDesc: '타고난 사주에 지금의 큰 흐름·올해·오늘 기운을 더해, 오늘 생길 수 있는 일과 대처를 풀어 드려요.', seePremium: '오늘의 운세 보기', seeAd: '광고 보고 무료로 보기', adFail: '광고를 불러오지 못했어요. 잠시 후 다시 시도하거나, 코인으로 광고를 없앨 수 있어요.',
  },
  settings: {
    homeOrder: '홈 배치 순서', homeOrderNote: '홈 화면에 보이는 순서예요. 위/아래로 옮겨 보세요.', homeOrderReset: '기본 순서로 되돌리기',
    account: '계정', loginCta: '로그인 / 회원가입', premium: '코인',
    premiumActive: '✓ 보유 중', premiumBuy: '코인 충전', premiumDesc: '코인으로 원하는 풀이만 골라 열어요 · 유효기간 없음', premiumScope: '※ 코인은 원하는 풀이에 자유롭게 쓸 수 있어요.',
    premiumOkTitle: '충전 완료', premiumOk: '코인이 충전됐어요.', premiumTitle: '코인',
    deleteAccount: '계정 삭제',
  ...
  timeline: {
    ...
    premiumTitle: '인생 타임라인', premiumMsg: '10~100세를 시기별로 풀어 드려요. 코인으로 열 수 있어요.',
  ...
  nav: { home: '홈', contents: '풀이', community: '커뮤니티', coach: '도우미', market: '마켓' },
  ...
  renewal: { title: '최신 통변으로 다시 받기', msg: '이 풀이를 받은 지 1년이 지났어요.\n\n{{pct}}% 할인된 {{coins}}코인으로 지금 시점 기준으로 다시 풀어 드려요. (보유 {{have}}코인)', later: '다음에', go: '재통변하기', needTitle: '코인이 부족해요', needMsg: '재통변에는 {{need}}코인이 필요해요. 지금 {{have}}코인 있어요.' },
...
const en = {
  ...
  renewal: { title: 'Get an updated reading', msg: "It's been a year since this reading.\n\nFor {{coins}} coins ({{pct}}% off) we'll read it again for where you are now. (You have {{have}})", later: 'Later', go: 'Read again', needTitle: 'Not enough coins', needMsg: 'This needs {{need}} coins. You have {{have}}.' },
...
const ja = {
  ...
  renewal: { title: '最新の内容で読み直す', msg: 'この占いから1年が過ぎました。\n\n{{pct}}%割引の{{coins}}コインで、今の時点で読み直します。（保有{{have}}コイン）', later: 'あとで', go: '読み直す', needTitle: 'コインが足りません', needMsg: '読み直しには{{need}}コイン必要です。現在{{have}}コインです。' },
