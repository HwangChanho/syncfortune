...
const ko = {
  ...
  gem: { title: '내 사주 보석', sub: '생일 보석은 사실 나와 안 맞아요 — 나를 살리는 진짜 보석', note: '※ 오행 기운과 색이 통하는 보석 제안이에요. 재미로 참고하세요(효능을 단정하지 않아요).', empty: '명식을 등록하면 나에게 맞는 보석을 찾아드려요', emptyCta: '+ 명식 등록' },
...
const en = {
  ...
  gem: { title: 'My Saju Gemstone', sub: 'Your birthstone may not fit you — the gem that truly lifts you', note: '※ Gems whose element energy & color resonate with yours. For fun — no efficacy claims.', empty: 'Register a chart to find gems that fit you', emptyCta: '+ Add chart' },
...
const ja = {
  ...
  gem: { title: '私の四柱宝石', sub: '誕生石は実はあなたに合わない — あなたを活かす本当の宝石', note: '※ 五行の気と色が通じる宝石の提案です。効能は断定しません、遊びとしてご参考に。', empty: '命式を登録すると合う宝石を見つけます', emptyCta: '+ 命式登録' },
