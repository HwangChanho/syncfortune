...
const ko = {
  ...
  life: { genFail: '생성에 실패했어요. 잠시 후 다시 시도해 주세요.', gateTitle: '인생 그래프', generating: '인생 흐름을 그리는 중…', yongsin: '나에게 필요한 기운', focus: '집중', hint: '곡선의 점을 눌러 그 시기를 자세히 볼 수 있어요.', peak: '가장 빛나는 시기', caution: '다지고 조심할 시기', advice: '평생 이렇게', gateDesc: '타고난 기운에 필요한 흐름을 기준으로, 10년 단위 인생 곡선과 전환점을 그려 드려요.', pv1: '나에게 필요한 기운', pv2: '10년 단위 인생 곡선', pv3: '인생의 전환점', pv4: '가장 빛나는 시기', pv5: '다지고 조심할 시기', see: '인생 그래프 보기', seePaid: '인생 그래프 보기 (₩3,900)' },
...
const en = {
  ...
  life: { genFail: 'Something went wrong. Please try again in a moment.', gateTitle: 'Life Graph', generating: 'Drawing your life journey…', yongsin: 'The energy you need', focus: 'Focus', hint: 'Tap a point on the curve to see that period in detail.', peak: 'Your brightest years', caution: 'Time to build up and take care', advice: 'A lifelong guide', gateDesc: 'Based on the flow that suits your nature, we map out your life curve in 10-year spans along with its turning points.', pv1: 'The energy you need', pv2: 'Your life curve in 10-year spans', pv3: "Life's turning points", pv4: 'Your brightest years', pv5: 'Time to build up and take care', see: 'View Life Graph', seePaid: 'View Life Graph (₩3,900)' },
...
const ja = {
  ...
  life: { genFail: '作成に失敗しました。少し時間をおいてからもう一度お試しください。', gateTitle: '人生グラフ', generating: '人生の流れを描いています…', yongsin: 'あなたに必要なエネルギー', focus: 'フォーカス', hint: '曲線上の点をタップすると、その時期を詳しく見られます。', peak: '最も輝く時期', caution: '足場を固めて気をつける時期', advice: '一生を通じての心がけ', gateDesc: 'あなたの持ち味に合った流れをもとに、10年ごとの人生曲線と転換点を描き出します。', pv1: 'あなたに必要なエネルギー', pv2: '10年ごとの人生曲線', pv3: '人生の転換点', pv4: '最も輝く時期', pv5: '足場を固めて気をつける時期', see: '人生グラフを見る', seePaid: '人生グラフを見る（₩3,900）' },
