...
const ko = {
  ...
  menu: {
    ...
    persona: '성격유형', personaDesc: '사주로 보는 나의 16유형', egen: '에겐 vs 테토', mbti: '사주 MBTI', traits: '나의 특징', joseonjob: '조선시대 직업', lovestyle: '연애 스타일', bok: '타고난 복', pastlife: '전생 이야기', healing: '나만의 힐링 방법',
