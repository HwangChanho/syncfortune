...
const ko = {
  ...
  menu: {
    ...
    dayPillar: '일주론', dayPillarDesc: '태어난 날로 보는 나의 기질', career: '사업가의 나', careerDesc: '사업가 vs 직장인, 두 길 풀이', gaeun: '맞춤 개운법', gaeunDesc: '지금 운에 맞춰 운을 살리는 법', talent: '나의 타고난 재능', talentDesc: '재능·좋아하는 일·돈 다루는 법', numerology: '수비학', numerologyDesc: '수로 보는 인생 방향·재능', astrology: '별자리·점성술', astrologyDesc: '내 별자리 + 네이탈 차트, 두 관점 깊이 풀이',
...
const en = {
  ...
  menu: {
    ...
    dayPillar: 'Day Pillar', dayPillarDesc: 'Your nature by your birth day', career: 'Founder or Employee', careerDesc: 'Your two paths: business vs job', gaeun: 'Lucky Boost', gaeunDesc: 'Lift your luck for this cycle', talent: 'My Innate Talent', talentDesc: 'Your gifts, drive, and money style', numerology: 'Numerology', numerologyDesc: 'Your life path and talents by number', astrology: 'Zodiac & Astrology', astrologyDesc: 'Your star sign + full natal chart',
...
const ja = {
  ...
  menu: {
    ...
    dayPillar: '日柱論', dayPillarDesc: '生まれた日でみる気質', career: '起業家の私 vs 会社員の私', careerDesc: '独立と組織、二つの道', gaeun: 'あなたの開運法', gaeunDesc: '今の運に合わせて運を活かす', talent: '私の生まれ持った才能', talentDesc: '才能·向く道·お金の扱い方', numerology: '数秘術', numerologyDesc: '数で見る人生の方向·才能', astrology: '星座·占星術', astrologyDesc: '星座 + ネイタルチャート、二つの視点',
