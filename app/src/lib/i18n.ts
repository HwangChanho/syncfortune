...
const ja = {
  ...
  special: { previewHead: 'こんなことが分かります', unlock: '運で開く', couponHint: '運で開けます', couponOnly: '運で開けます。マーケットでチャージできます。', needPay: '利用券が必要です。もう一度お試しください。', needPayMsg: '利用券が必要です。今すぐ購入するか、マーケットで受け取れます。', buyNow: '今すぐ購入', goMarket: 'マーケットで見る', unlockCta: '購入して見る', unlockHint: '運で開けます' },
