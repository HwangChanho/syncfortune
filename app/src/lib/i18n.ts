...
const ko = {
  ...
  menu: {
    ...
    secFree: '오늘·명식', secPremium: '프리미엄', secContent: '가장 많이 찾는', secSpecial: '스페셜', secDeep: '나에 대해 알기', secLight: '가볍게 보기',
  ...
  settings: {
    ...
    appInfo: '앱 정보', version: '버전', terms: '이용약관', privacy: '개인정보처리방침', license: '오픈소스 라이선스',
  ...
  love: {
    ...
    timing: '애정이 무르익는 시기', caution: '조심할 점', advice: '좋은 인연을 가꾸는 법', needPay: '이용권이 필요해요. 다시 시도해 주세요.',
  },
  ...
  newyear: { title: '신년운세', generating: '올 한 해를 풀어내는 중…', heroSub: '올 한 해의 큰 흐름을 한눈에', keyword: '올해의 키워드', lucky: '올해의 행운 포인트', halves: '상반기 · 하반기', months: '달별 캘린더', samjaeAdvice: '올해 특히 챙길 점', resolution: '올해를 이렇게', gateDesc: '올해의 키워드부터 분야별 운, 열두 달 캘린더, 새해 다짐까지 한 번에 정리해 드려요.', pv1: '올해의 키워드', pv2: '분야별 운 8가지', pv3: '열두 달 캘린더', pv4: '상·하반기 흐름', pv5: '올해 다질 점·새해 다짐', see: '신년운세 보기', seePaid: '신년운세 보기 (₩6,900)', bottomNote: "※ 올 한 해의 큰 흐름이에요. 매일의 운세는 '오늘의 운세'에서 확인하세요." },
  ...
  dream: { fail: '해몽을 불러오지 못했어요. 잠시 후 다시 시도해 주세요.', title: '꿈해몽', sub: '꿈에 나온 것을 검색해 보세요.', placeholder: '예: 돼지, 뱀, 물…', generating: 'AI가 해몽을 풀어내는 중…', notInDict: '사전에 없는 꿈이에요. AI 해몽을 받아보세요.', aiSee: 'AI 해몽 보기', note: '※ 가볍게 즐기는 전통 해몽이에요.' },
...
const en = {
  ...
  menu: {
    ...
    secFree: 'Today & Chart', secPremium: 'Premium', secContent: 'Most Popular', secSpecial: 'Special', secDeep: 'Know Yourself', secLight: 'For Fun',
  ...
  settings: {
    ...
    appInfo: 'App Info', version: 'Version', terms: 'Terms of Service', privacy: 'Privacy Policy', license: 'Open Source Licenses',
  ...
  love: {
    ...
    timing: 'When love ripens', caution: 'What to watch for', advice: 'How to nurture a good connection', needPay: 'You need a pass to continue. Please try again.',
  },
...
const ja = {
  ...
  menu: {
    ...
    secFree: '今日・命式', secPremium: 'プレミアム', secContent: '人気の占い', secSpecial: 'スペシャル', secDeep: '自分を知る', secLight: '気軽に',
  ...
  settings: {
    ...
    appInfo: 'アプリ情報', version: 'バージョン', terms: '利用規約', privacy: 'プライバシーポリシー', license: 'オープンソースライセンス',
  ...
  love: {
    ...
    timing: '恋が深まる時期', caution: '気をつけること', advice: '良い縁を育てる方法', needPay: '利用券が必要です。もう一度お試しください。',
  },
  ...
  newyear: { title: '新年の運勢', generating: '今年一年を読み解いています…', heroSub: '今年一年の大きな流れをひと目で', keyword: '今年のキーワード', lucky: '今年のラッキーポイント', halves: '上半期・下半期', months: '月ごとのカレンダー', samjaeAdvice: '今年とくに気をつけたいこと', resolution: '今年はこんなふうに', gateDesc: '今年のキーワードから分野ごとの運勢、12か月のカレンダー、新年の抱負まで、まとめてお届けします。', pv1: '今年のキーワード', pv2: '分野ごとの運勢8つ', pv3: '12か月のカレンダー', pv4: '上半期・下半期の流れ', pv5: '今年固めたいこと・新年の抱負', see: '新年の運勢を見る', seePaid: '新年の運勢を見る（₩6,900）', bottomNote: '※ これは今年一年の大きな流れです。毎日の運勢は「今日の運勢」でご確認ください。' },
  ...
  dream: { fail: '夢の意味を読み込めませんでした。しばらくしてからもう一度お試しください。', title: '夢占い', sub: '夢に出てきたものを検索してみましょう。', placeholder: '例：豚、ヘビ、水…', generating: 'AIが夢を読み解いています…', notInDict: '辞書にない夢です。AIの夢占いを受けてみましょう。', aiSee: 'AIの夢占いを見る', note: '※ 気軽に楽しむ伝統的な夢占いです。' },
