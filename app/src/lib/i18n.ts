...
const ko = {
  ...
  menu: {
    ...
    persona: '성격유형', personaDesc: '사주로 보는 나의 16유형', egen: '에겐 vs 테토', mbti: '사주 MBTI', traits: '나의 특징', selfAnalysis: '나 분석', selfAnalysisDesc: '성격·기질·오행 밸런스를 한눈에 종합 분석', relationPattern: '관계 패턴', relationPatternDesc: '왜 내 관계는 반복되는가 — 타고난 관계의 결', joseonjob: '조선시대 직업', lovestyle: '연애 스타일', bok: '타고난 복', pastlife: '전생 이야기', healing: '나만의 힐링 방법',
...
const ja = {
  ...
  menu: {
    ...
    persona: '性格タイプ', personaDesc: '四柱で見る私の16タイプ', egen: 'エゲン vs テト', mbti: '四柱MBTI', selfAnalysis: '自己分析', selfAnalysisDesc: '性格·気質·五行バランスをまとめて分析', relationPattern: '関係パターン', relationPatternDesc: 'なぜ関係が繰り返すか — 生まれ持った関係の質', joseonjob: '朝鮮時代の職業', lovestyle: '恋愛スタイル', bok: '生まれ持つ福', pastlife: '前世物語', healing: '私の癒し方',
