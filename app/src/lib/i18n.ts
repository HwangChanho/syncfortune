...
const ko = {
  ...
  menu: {
    ...
    dayPillar: '일주론', dayPillarDesc: '태어난 날로 보는 나의 기질', career: '사업가의 나', careerDesc: '사업가 vs 직장인, 두 길 풀이', talent: '나의 타고난 재능', talentDesc: '재능·좋아하는 일·돈 다루는 법',
...
const en = {
  ...
  menu: {
    ...
    dayPillar: 'Day Pillar', dayPillarDesc: 'Your nature by your birth day', career: 'Founder or Employee', careerDesc: 'Your two paths: business vs job', talent: 'My Innate Talent', talentDesc: 'Your gifts, drive, and money style',
...
const ja = {
  ...
  menu: {
    ...
    dayPillar: '日柱論', dayPillarDesc: '生まれた日でみる気質', career: '起業家の私 vs 会社員の私', careerDesc: '独立と組織、二つの道', talent: '私の生まれ持った才能', talentDesc: '才能·向く道·お金の扱い方',
