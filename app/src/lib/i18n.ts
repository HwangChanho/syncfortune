...
const ko = {
  ...
  menu: {
    ...
    taegil: '택일', country: '맞는 나라', countryDesc: '내 기운에 맞는 나라·기후', taegilDesc: '결혼·이사·계약 좋은 날',
...
const en = {
  ...
  menu: {
    ...
    taegil: 'Lucky Days', country: 'Best Country', countryDesc: 'Countries that fit your energy', taegilDesc: 'Best days for wedding · moving · contracts',
...
const ja = {
  ...
  menu: {
    ...
    taegil: '択日', country: '合う国', countryDesc: '気運に合う国·気候', taegilDesc: '結婚・引越し・契約の吉日',
    luck: '今日の幸運', luckDesc: '幸運の色·方角·数字',
    zodiac: '干支·星座', zodiacDesc: '今日の干支·星座運勢',
    name: '名前占い', nameDesc: '名前の五行の流れ',
    dream: '夢占い', dreamDesc: 'キーワードで探す',
    dayPillar: '日柱論', dayPillarDesc: '生まれた日でみる気質', career: '起業家の私 vs 会社員の私', careerDesc: '独立と組織、二つの道', gaeun: 'あなたの開運法', gaeunDesc: '今の運に合わせて運を活かす', followupDesc: '占いにもう一つ質問', talent: '私の生まれ持った才能', talentDesc: '才能·向く道·お金の扱い方', numerology: '数秘術', numerologyDesc: '数で見る人生の方向·才能', astrology: '星座·占星術', astrologyDesc: '星座 + ネイタルチャート、二つの視点',
