...
const ko = {
  ...
  reading: {
    ...
    watchAd: '광고 보고 1회', payPerUse: '₩2,500 결제', bannerPerUse: '✨ 첫 분야만 미리보기예요 — 전체 풀이는 광고 시청 또는 ₩2,500',
  ...
  love: {
    ...
    behavior: '그 사람의 행동·말투·습관', howWeMeet: '어떻게·어디서 만나게 될까', elementMatch: '나와 잘 맞는 상대의 기운 순위', dynamic: '둘 사이의 끌림과 호흡',
...
const en = {
  ...
  reading: {
    ...
    watchAd: 'Watch ad (1x)', payPerUse: 'Pay ₩2,500', bannerPerUse: '✨ Only the first area is a preview — unlock all with an ad or ₩2,500',
  ...
  love: {
    ...
    behavior: 'Their behavior, speech & habits', howWeMeet: 'How & where you’ll meet', elementMatch: 'Best-matched energy types, ranked', dynamic: 'The chemistry between you',
...
const ja = {
  ...
  reading: {
    ...
    watchAd: '広告を見る（1回）', payPerUse: '₩2,500 決済', bannerPerUse: '✨ 最初の分野のみプレビューです — 全体は広告視聴または₩2,500',
  ...
  love: {
    ...
    behavior: 'その人の行動·話し方·習慣', howWeMeet: 'どこで·どう出会うか', elementMatch: '相性の良い気の順位', dynamic: '二人の惹かれ合いと相性',
