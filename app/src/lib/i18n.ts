...
const ko = {
  ...
  reading: {
    ...
    askPremiumCta: 'woon으로 더 물어보기', askPayTitle: '추가 질문', askPayMsg: '무료 질문을 다 쓰셨어요. 건당 {{price}}으로 더 물어보시겠어요?',
  ...
  compat: {
    ...
    premiumTitle: '궁합 풀이', premiumMsg: '관계마다 따로 풀어 드려요. woon으로 열 수 있어요.',
  ...
  today: {
    ...
    more: '분야별로 자세히 보기 →',
    genFail: '풀이 생성에 실패했어요. 잠시 후 다시 시도해 주세요.', title: '오늘의 운세', heroSub: '오늘 일진으로 보는 하루 흐름', generating: '오늘의 흐름을 풀어내는 중…', gateTitle: '오늘의 운세 보기', gateDesc: '타고난 사주에 지금의 큰 흐름·올해·오늘 기운을 더해, 오늘 생길 수 있는 일과 대처를 풀어 드려요.', seePremium: '오늘의 운세 보기', seeAd: '광고 보고 무료로 보기', adFail: '광고를 불러오지 못했어요. 잠시 후 다시 시도하거나, woon으로 광고를 없앨 수 있어요.',
  },
  settings: {
    ...
    premiumActive: '✓ 보유 중', premiumBuy: 'woon 충전', premiumDesc: 'woon으로 원하는 풀이만 골라 열어요 · 유효기간 없음', premiumScope: '※ woon은 원하는 풀이에 자유롭게 쓸 수 있어요.',
    premiumOkTitle: '충전 완료', premiumOk: 'woon이 충전됐어요.', premiumTitle: 'woon',
    deleteAccount: '계정 삭제',
  ...
  timeline: {
    ...
    premiumTitle: '인생 타임라인', premiumMsg: '10~100세를 시기별로 풀어 드려요. woon으로 열 수 있어요.',
  ...
  special: { previewHead: '이런 걸 풀어드려요', unlock: 'woon으로 열기', couponHint: 'woon으로 열 수 있어요', couponOnly: 'woon으로 열 수 있어요. 마켓에서 woon을 충전할 수 있어요.', needPay: '이용권이 필요해요. 다시 시도해 주세요.', needPayMsg: '이용권이 필요해요. 바로 구매하거나 마켓에서 받을 수 있어요.', buyNow: '바로 구매', goMarket: '마켓에서 보기', unlockCta: '구매하고 보기', unlockHint: 'woon으로 열려요' },
  ...
  renewal: { title: '최신 통변으로 다시 받기', msg: '이 풀이를 받은 지 1년이 지났어요.\n\n{{pct}}% 할인된 {{coins}} woon으로 지금 시점 기준으로 다시 풀어 드려요. (보유 {{have}} woon)', later: '다음에', go: '재통변하기', needTitle: 'woon이 부족해요', needMsg: '재통변에는 {{need}} woon이 필요해요. 지금 {{have}} woon 있어요.' },
...
const ja = {
  ...
  special: { previewHead: 'こんなことが分かります', unlock: 'woonで開く', couponHint: 'woonで開けます', couponOnly: 'woonで開けます。マーケットでチャージできます。', needPay: '利用券が必要です。もう一度お試しください。', needPayMsg: '利用券が必要です。今すぐ購入するか、マーケットで受け取れます。', buyNow: '今すぐ購入', goMarket: 'マーケットで見る', unlockCta: '購入して見る', unlockHint: 'woonで開けます' },
