...
const ko = {
  ...
  menu: {
    ...
    secFree: '오늘·명식', secPremium: '프리미엄', secContent: '가장 많이 찾는', secDeep: '나에 대해 알기', secLight: '가볍게 보기',
...
const en = {
  ...
  menu: {
    ...
    secFree: 'Today & Chart', secPremium: 'Premium', secContent: 'Most Popular', secDeep: 'Know Yourself', secLight: 'For Fun',
...
const ja = {
  ...
  menu: {
    ...
    secFree: '今日・命式', secPremium: 'プレミアム', secContent: '人気の占い', secDeep: '自分を知る', secLight: '気軽に',
