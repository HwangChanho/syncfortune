...
const ko = {
  ...
  child: { title: '자식운', sub: '원국으로 보는 자녀 인연·기질·부모로서의 나', gen: '자녀 인연을 살피는 중…', bigPicture: '자녀 인연의 큰 그림', childNature: '자녀의 기질', asParent: '부모로서의 나', coupleCross: '부부 자녀 인연', communication: '소통·관계', timing: '시기 흐름', talent: '자녀의 재능', health: '건강 관리축', remedy: '개운·처방' },
...
const en = {
  ...
  child: { title: 'Children', sub: 'Your bond with your children, their nature, and you as a parent — from your chart', gen: 'Reading your bond with your children…', bigPicture: 'The big picture of your bond', childNature: "Your child's nature", asParent: 'You as a parent', coupleCross: "The couple's bond with children", communication: 'Communication', timing: 'Timing & flow', talent: "Your child's talents", health: 'Health to manage', remedy: 'Ways to boost fortune' },
...
const ja = {
  ...
  child: { title: '子どもの縁', sub: '命式で見る子との縁·気質·親としての私', gen: '子との縁を見ています…', bigPicture: '子との縁の全体像', childNature: '子どもの気質', asParent: '親としての私', coupleCross: '夫婦の子との縁', communication: 'コミュニケーション', timing: '時期の流れ', talent: '子どもの才能', health: '健康の管理軸', remedy: '開運·処方' },
