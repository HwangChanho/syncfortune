...
const ko = {
  ...
  newyear: { title: '신년운세', generating: '올 한 해를 풀어내는 중…', heroSub: '올 한 해의 큰 흐름을 한눈에', keyword: '올해의 키워드', lucky: '올해의 행운 포인트', halves: '상반기 · 하반기', months: '달별 캘린더', flowNote: '※ 위=오르는 달 · 아래=다지는 달 · 숫자=절기 기준 달', samjaeAdvice: '올해 특히 챙길 점', resolution: '올해를 이렇게', gateDesc: '올해의 키워드부터 분야별 운, 열두 달 캘린더, 새해 다짐까지 한 번에 정리해 드려요.', pv1: '올해의 키워드', pv2: '분야별 운 8가지', pv3: '열두 달 캘린더', pv4: '상·하반기 흐름', pv5: '올해 다질 점·새해 다짐', see: '신년운세 보기', seePaid: '신년운세 보기 (₩6,900)', bottomNote: "※ 올 한 해의 큰 흐름이에요. 매일의 운세는 '오늘의 운세'에서 확인하세요." },
...
const ja = {
  ...
  newyear: { title: '新年の運勢', generating: '今年一年を読み解いています…', heroSub: '今年一年の大きな流れをひと目で', keyword: '今年のキーワード', lucky: '今年のラッキーポイント', halves: '上半期・下半期', months: '月ごとのカレンダー', flowNote: '※ 上=上向きの月 · 下=整える月 · 数字=節気基準の月', samjaeAdvice: '今年とくに気をつけたいこと', resolution: '今年はこんなふうに', gateDesc: '今年のキーワードから分野ごとの運勢、12か月のカレンダー、新年の抱負まで、まとめてお届けします。', pv1: '今年のキーワード', pv2: '分野ごとの運勢8つ', pv3: '12か月のカレンダー', pv4: '上半期・下半期の流れ', pv5: '今年固めたいこと・新年の抱負', see: '新年の運勢を見る', seePaid: '新年の運勢を見る（₩6,900）', bottomNote: '※ これは今年一年の大きな流れです。毎日の運勢は「今日の運勢」でご確認ください。' },
