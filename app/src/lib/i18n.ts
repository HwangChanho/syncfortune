...
const ko = {
  ...
  menu: {
    ...
    dayPillar: '일주론', dayPillarDesc: '태어난 날로 보는 나의 기질', career: '사업가의 나', careerDesc: '사업가 vs 직장인, 두 길 풀이', talent: '나의 타고난 재능', talentDesc: '재능·좋아하는 일·돈 다루는 법', numerology: '수비학', numerologyDesc: '수로 보는 인생 방향·재능', astrology: '별자리 운세', astrologyDesc: '태양·달·상승궁으로 보는 나',
  ...
  astrology: { title: '별자리 운세', sub: '태어난 순간 하늘로 보는 나 — 태양·달·상승궁과 행성들', generating: '별자리를 읽는 중…', summary: '한눈에', big3: '태양·달·상승궁', love: '사랑·욕구', work: '일·성취', strength: '타고난 강점', challenge: '과제', advice: '한마디' },
...
const en = {
  ...
  astrology: { title: 'Astrology', sub: 'You by the sky at your birth — sun, moon, rising, and the planets', generating: 'Reading the stars…', summary: 'At a glance', big3: 'Sun · Moon · Rising', love: 'Love & desire', work: 'Work & achievement', strength: 'Your strengths', challenge: 'Your challenge', advice: 'A word' },
...
const ja = {
  ...
  menu: {
    ...
    dayPillar: '日柱論', dayPillarDesc: '生まれた日でみる気質', career: '起業家の私 vs 会社員の私', careerDesc: '独立と組織、二つの道', talent: '私の生まれ持った才能', talentDesc: '才能·向く道·お金の扱い方', numerology: '数秘術', numerologyDesc: '数で見る人生の方向·才能', astrology: '星占い', astrologyDesc: '太陽·月·上昇星座で見る私',
  ...
  astrology: { title: '星占い', sub: '生まれた瞬間の空で見る私 — 太陽·月·上昇星座と惑星', generating: '星を読んでいます…', summary: 'ひと目で', big3: '太陽·月·上昇星座', love: '愛·欲求', work: '仕事·成就', strength: '強み', challenge: '課題', advice: 'ひとこと' },
