...
const ko = {
  ...
  menu: {
    ...
    persona: '성격유형', personaDesc: '사주로 보는 나의 16유형', egen: '에겐 vs 테토', mbti: '사주 MBTI', traits: '나의 특징', selfAnalysis: '나 분석', selfAnalysisDesc: '성격·기질·오행 밸런스를 한눈에 종합 분석', relationPattern: '관계 패턴', relationPatternDesc: '왜 내 관계는 반복되는가 — 타고난 관계의 결', personal: '퍼스널 오행', personalDesc: '내 오행에 맞는 컬러·코디·메이크업·자동차 색', sokgunghap: '속궁합', sokgunghapDesc: '두 사람의 성적 궁합 (성인·재미)', community: '커뮤니티', communityDesc: '사주·연애·고민을 함께 나누는 공간', joseonjob: '조선시대 직업', lovestyle: '연애 스타일', bok: '타고난 복', pastlife: '전생 이야기', healing: '나만의 힐링 방법',
  ...
  reading: {
    ...
    premiumAlert: '프리미엄 통변', premiumAlertMsg: '건당 {{price}} 결제로 깊은 통변을 봅니다.',
    payPerUse: '{{price}} 결제', bannerPerUse: '✨ 첫 분야만 미리보기예요 — 전체 풀이는 {{price}}',
    ...
    askPremiumCta: '프리미엄으로 더 물어보기', askPayTitle: '추가 질문', askPayMsg: '무료 질문을 다 쓰셨어요. 건당 {{price}}으로 더 물어보시겠어요?',
  ...
  lookback: { title: '되돌아보기', sub: '그날 운세와 내가 남긴 기록을 나란히 봐요.', needLogin: '로그인하면 기록이 계정에 저장되고 여기서 다시 볼 수 있어요.', empty: '아직 남긴 기록이 없어요. 오늘의 운세 아래에서 "오늘 어땠어요?"에 한 줄 남겨 보세요.', goToday: '오늘의 운세 보기', summary: '평가한 {{rated}}일 중 {{hit}}일을 "맞았다"고 하셨어요', summaryNote: '※ 스스로 매긴 기록이라 참고용이에요. 빗나간 날이 있으면 그게 더 값진 단서예요.', myNote: '내 기록', missionDone: '✓ 그날의 한 가지를 했어요' },
  ...
  personal: { title: '퍼스널 오행', sub: '내 오행에 맞는 컬러·코디·메이크업·자동차 색', activate: '나를 살리는 색', balance: '채우면 좋은 색', yongsin: ' (내게 필요한 기운)', cody: '코디', makeup: '메이크업', car: '자동차 색', note: '※ 오행 기운에 맞춘 컬러 제안이에요. 취향과 함께 재미로 참고하세요.', empty: '명식을 등록하면 내 오행에 맞는 컬러를 찾아드려요', emptyCta: '+ 명식 등록' },
...
const en = {
  ...
  reading: {
    ...
    payPerUse: 'Pay {{price}}', bannerPerUse: '✨ Only the first area is a preview — unlock all for {{price}}',
  ...
  lookback: { title: 'Look back', sub: "Your notes next to that day's reading.", needLogin: 'Sign in to save your notes and revisit them here.', empty: 'No notes yet. Leave a line under today\'s reading.', goToday: "See today's reading", summary: 'You marked {{hit}} of {{rated}} rated days as accurate', summaryNote: '※ These are your own ratings, so treat them as a reference. Days that missed are the more useful clue.', myNote: 'My note', missionDone: '✓ Did that day\'s one thing' },
...
const ja = {
  ...
  menu: {
    ...
    persona: '性格タイプ', personaDesc: '四柱で見る私の16タイプ', egen: 'エゲン vs テト', mbti: '四柱MBTI', selfAnalysis: '自己分析', selfAnalysisDesc: '性格·気質·五行バランスをまとめて分析', relationPattern: '関係パターン', relationPatternDesc: 'なぜ関係が繰り返すか — 生まれ持った関係の質', personal: 'パーソナル五行', personalDesc: '五行に合うカラー·コーデ·メイク·車の色', sokgunghap: '相性(夜)', sokgunghapDesc: '二人の性的相性 (成人·遊び)', community: 'コミュニティ', communityDesc: '四柱·恋愛·悩みを分かち合う場所', joseonjob: '朝鮮時代の職業', lovestyle: '恋愛スタイル', bok: '生まれ持つ福', pastlife: '前世物語', healing: '私の癒し方',
    ...
    child: '子どもの縁', childDesc: '子との縁·気質·親としての私', future10: '10年後の私', future10Desc: '大運·歳運で描く10年後', reunion: '復縁', reunionDesc: '元の縁が再び開く時期·可能性', crush: '片思い·ご縁運', crushDesc: '想いが届くか·惹かれる人の質·近づく時期', job: '就職·転職運', jobDesc: '就職·転職·合格·試験が動きやすい時期', jobfit: '私に合う職業', jobfitDesc: '生まれ持った適性で合う職業·惹かれと能力の差', reunionAsk: '復縁できる？', reunionAskDesc: '無料で見る復縁の可能性·連絡に良い月', crushAsk: 'あの人と結ばれる？', crushAskDesc: '無料で見る魅力·ご縁が高まる月', jobAsk: '就職はいつ？', jobAskDesc: '無料で見る就職·合格運が開く時期',
  ...
  reading: {
    ...
    payPerUse: '{{price}} 決済', bannerPerUse: '✨ 最初の分野のみプレビューです — 全体は{{price}}',
  ...
  lookback: { title: '振り返り', sub: 'その日の運勢と自分の記録を並べて見ます。', needLogin: 'ログインすると記録が保存され、ここで見返せます。', empty: 'まだ記録がありません。今日の運勢の下に一行残してみてください。', goToday: '今日の運勢を見る', summary: '評価した{{rated}}日のうち{{hit}}日を「当たった」とされました', summaryNote: '※ ご自身の評価なので参考程度に。外れた日こそ手がかりになります。', myNote: '私の記録', missionDone: '✓ その日の一つを実行しました' },
  ...
  personal: { title: 'パーソナル五行', sub: '五行に合うカラー·コーデ·メイク·車の色', activate: '私を活かす色', balance: '補うと良い色', yongsin: '（私に必要な気）', cody: 'コーデ', makeup: 'メイク', car: '車の色', note: '※ 五行の気に合わせたカラー提案です。好みと一緒に楽しんでご参考に。', empty: '命式を登録すると五行に合う色を見つけます', emptyCta: '+ 命式登録' },
