...
const ko = {
  ...
  sok: { title: '속궁합', sub: '두 사람의 성적 궁합을 사주로 — 재미로 보는 성인 콘텐츠', gateTitle: '성인(19세 이상) 콘텐츠', gateDesc: '속궁합은 두 사람의 성적 궁합을 사주로 풀어보는 성인용 콘텐츠예요. 재미로만 즐겨 주세요.', gateConfirm: '만 19세 이상입니다 · 시작', pickPartner: '상대 선택', newPartner: '새 상대 입력', registerSubmit: '이 상대로 속궁합 보기', spouseLabel: '배우자궁 케미', adviceLabel: '더 좋아지는 법', disclaimer: '※ 사주로 보는 재미 콘텐츠예요. 실제 관계는 두 사람이 만들어갑니다. 성인(19세 이상) 전용.' },
...
const ja = {
  ...
  sok: { title: '相性(夜)', sub: '二人の性的相性を四柱で — 大人の遊び', gateTitle: '成人(19歳以上)コンテンツ', gateDesc: '二人の性的相性を四柱で読み解く成人向けコンテンツです。遊びとしてお楽しみください。', gateConfirm: '19歳以上です · 開始', pickPartner: '相手を選ぶ', newPartner: '新しい相手', registerSubmit: 'この相手で見る', spouseLabel: '配偶者宮の相性', adviceLabel: 'もっと良くする方法', disclaimer: '※ 四柱で見る遊びコンテンツです。実際の関係は二人が作ります。成人(19歳以上)限定。' },
