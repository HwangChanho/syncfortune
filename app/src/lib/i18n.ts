...
const ko = {
  ...
  special: { previewHead: '이런 걸 풀어드려요', unlock: '운으로 열기', couponHint: '운으로 열 수 있어요', couponOnly: '운으로 열 수 있어요. 마켓에서 운을 충전할 수 있어요.', needPay: '이용권이 필요해요. 다시 시도해 주세요.', needPayMsg: '이용권이 필요해요. 바로 구매하거나 마켓에서 받을 수 있어요.', buyNow: '바로 구매', goMarket: '마켓에서 보기', unlockCta: '구매하고 보기', unlockHint: '운으로 열려요' },
