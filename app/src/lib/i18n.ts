...
const ko = {
  ...
  assist: { title: '우니', sub: '보고 싶은 걸 말해 주세요. 바로 그 자리로 데려다 드려요.', label: '우니', hello: '무엇을 보고 싶으세요? 세 가지 중에 고르셔도 되고, 그냥 편하게 말해 주셔도 돼요.', egLabel: '이렇게 말해도 알아들어요', miss: '제가 아직 그 말은 못 알아들었어요. 아래에서 골라 주시면 바로 안내해 드릴게요.', placeholder: '무엇을 보고 싶으세요?', send: '보내기', note: '※ 도우미는 콘텐츠를 찾아 주는 안내예요. 풀이 내용은 각 콘텐츠에서 볼 수 있어요.' },
...
const ja = {
  ...
  assist: { title: 'ウォニ', sub: '見たいものを教えてください。そこまでご案内します。', label: 'ガイド', hello: '何をご覧になりますか？ 三つから選んでも、そのまま話しかけても大丈夫です。', egLabel: 'こんな風に言っても大丈夫', miss: 'まだその言葉は分かりませんでした。下から選んでいただければすぐご案内します。', placeholder: '何を見たいですか？', send: '送信', note: '※ ガイドはコンテンツを探す案内です。占いの内容は各コンテンツでご覧いただけます。' },
