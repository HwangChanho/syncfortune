...
const ko = {
  ...
  menu: {
    ...
    dayPillar: '일주론', dayPillarDesc: '태어난 날로 보는 나의 기질', career: '사업가의 나', careerDesc: '사업가 vs 직장인, 두 길 풀이', talent: '나의 타고난 재능', talentDesc: '재능·좋아하는 일·돈 다루는 법', numerology: '수비학', numerologyDesc: '수로 보는 인생 방향·재능', astrology: '별자리·점성술', astrologyDesc: '내 별자리 + 네이탈 차트, 두 관점 깊이 풀이',
  ...
  astrology: { title: '별자리·점성술', sub: '내 별자리(태양별자리)와 점성술(네이탈 차트)을 한 번에 — 두 관점으로 깊이', generating: '별자리·점성술을 읽는 중…', signSummary: '⭐ 별자리 — 내 태양별자리', signTraits: '별자리 · 성격·기질', signLove: '별자리 · 연애 스타일', signStrength: '별자리 · 강점·매력', big3: '🔭 점성술 — 태양·달·상승궁', natalLove: '점성술 · 사랑·욕구', natalWork: '점성술 · 일·성취', strength: '점성술 · 타고난 강점', challenge: '점성술 · 과제', advice: '한마디' },
...
const en = {
  ...
  astrology: { title: 'Zodiac & Astrology', sub: 'Your star sign + full natal chart — two views in one', generating: 'Reading your stars…', signSummary: '⭐ Star Sign — Your Sun Sign', signTraits: 'Sign · Personality', signLove: 'Sign · Love style', signStrength: 'Sign · Strengths', big3: '🔭 Astrology — Sun·Moon·Rising', natalLove: 'Astrology · Love & desire', natalWork: 'Astrology · Work', strength: 'Astrology · Strengths', challenge: 'Astrology · Challenge', advice: 'A word' },
...
const ja = {
  ...
  menu: {
    ...
    dayPillar: '日柱論', dayPillarDesc: '生まれた日でみる気質', career: '起業家の私 vs 会社員の私', careerDesc: '独立と組織、二つの道', talent: '私の生まれ持った才能', talentDesc: '才能·向く道·お金の扱い方', numerology: '数秘術', numerologyDesc: '数で見る人生の方向·才能', astrology: '星座·占星術', astrologyDesc: '星座 + ネイタルチャート、二つの視点',
  ...
  astrology: { title: '星座·占星術', sub: '星座(太陽星座)とネイタルチャートを一度に — 二つの視点で', generating: '星を読んでいます…', signSummary: '⭐ 星座 — 私の太陽星座', signTraits: '星座 · 性格', signLove: '星座 · 恋愛スタイル', signStrength: '星座 · 強み', big3: '🔭 占星術 — 太陽·月·上昇', natalLove: '占星術 · 愛·欲求', natalWork: '占星術 · 仕事', strength: '占星術 · 強み', challenge: '占星術 · 課題', advice: 'ひとこと' },
