...
const ko = {
  ...
  settings: {
    ...
    premiumActive: '✓ 보유 중', premiumBuy: '운 충전', premiumDesc: '운으로 원하는 풀이만 골라 열어요 · 유효기간 없음', premiumScope: '※ 운은 원하는 풀이에 자유롭게 쓸 수 있어요.',
  ...
  lookback: { title: '되돌아보기', sub2: '오늘의 한 가지를 해낸 날들이에요.', needLogin: '로그인하면 기록이 계정에 저장되고 여기서 다시 볼 수 있어요.', empty2: '아직 기록이 없어요. 오늘의 운세 아래 "오늘의 한 가지"를 해내고 체크해 보세요.', goToday: '오늘의 운세 보기', summary: '평가한 {{rated}}일 중 {{hit}}일을 "맞았다"고 하셨어요', summaryNote: '※ 스스로 매긴 기록이라 참고용이에요. 빗나간 날이 있으면 그게 더 값진 단서예요.', streak: '지금까지 {{n}}일, 오늘의 한 가지를 해내셨어요', myNote: '내 기록', missionDone: '✓ 그날의 한 가지를 했어요' },
  ...
  market: { intro: '운으로 열 명식을 고른 뒤, 보고 싶은 풀이를 누르세요.', applyTo: '적용할 명식', openApply: '열기', noChart: '저장된 명식이 없어요', have: '보유 {{n}}장', owned: '보유', notOwned: '미보유', buy: '구매', note: '풀이는 명식별로 저장돼요. 무료 쿠폰은 아래에서 등록하세요.', doneTitle: '구매 완료', doneMsg: '운이 지급되었어요.', payPending: '결제 준비 중', buyFailTitle: '구매 실패' },
  dayPillar: {
  ...
  special: { previewHead: '이런 걸 풀어드려요', unlock: '운으로 열기', couponHint: '운으로 열 수 있어요', couponOnly: '운으로 열 수 있어요. 마켓에서 운을 충전할 수 있어요.', needPay: '운이 필요해요. 다시 시도해 주세요.', needPayMsg: '운이 필요해요. 지금 운으로 열거나, 마켓에서 충전할 수 있어요.', buyNow: '바로 구매', goMarket: '마켓에서 보기', unlockCta: '구매하고 보기', unlockHint: '운으로 열려요' },
  ...
  newyear: { title: '신년운세', generating: '올 한 해를 풀어내는 중…', heroSub: '올 한 해의 큰 흐름을 한눈에', keyword: '올해의 키워드', lucky: '올해의 행운 포인트', halves: '상반기 · 하반기', months: '달별 캘린더', flowNote: '※ 위=오르는 달 · 아래=다지는 달 · 숫자=절기 기준 달', flowNoteLow: '※ 건강은 전체 흐름 기반 근사예요 · 위=오르는 달 · 아래=다지는 달', samjaeAdvice: '올해 특히 챙길 점', resolution: '올해를 이렇게', gateDesc: '올해의 키워드부터 분야별 운, 열두 달 캘린더, 새해 다짐까지 한 번에 정리해 드려요.', pv1: '올해의 키워드', pv2: '분야별 운 8가지', pv3: '열두 달 캘린더', pv4: '상·하반기 흐름', pv5: '올해 다질 점·새해 다짐', see: '신년운세 보기', seePaid: '신년운세 보기 (₩9,900)', bottomNote: "※ 올 한 해의 큰 흐름이에요. 매일의 운세는 '오늘의 운세'에서 확인하세요." },
  taegil: { title: '택일 — 좋은 날 찾기', sub: '하려는 일을 고르면, 앞으로 석 달 달력에서 내 사주에 잘 맞는 날을 색으로 짚어 드려요.', best: '아주 좋음', good: '좋음', tapHint: '색칠된 날을 눌러 보세요', note: '※ 사주에 맞춘 참고용 길일이에요. 실제 일정은 형편에 맞게 정하세요.' },  zodiac: { title: '띠·별자리 오늘운세', animal: '띠', sign: '별자리', mine: '내 운세', note: '※ 가볍게 즐기는 오늘의 운세예요. 자세한 풀이는 내 사주에서 보세요.' },
  ...
  assist: { title: '우니', sub: '보고 싶은 걸 말해 주세요. 바로 그 자리로 데려다 드려요.', label: '우니', hello: '무엇을 보고 싶으세요? 세 가지 중에 고르셔도 되고, 그냥 편하게 말해 주셔도 돼요.', egLabel: '이렇게 말해도 알아들어요', miss: '제가 아직 그 말은 못 알아들었어요. 아래에서 골라 주시면 바로 안내해 드릴게요.', placeholder: '무엇을 보고 싶으세요?', reset: '↺ 처음으로', send: '보내기', note: '※ 도우미는 콘텐츠를 찾아 주는 안내예요. 풀이 내용은 각 콘텐츠에서 볼 수 있어요.' },
  ...
  gem: { title: '내 사주 보석', birthstoneTitle: '탄생석, 어떤 의미일까', sub: '생일 보석은 사실 나와 안 맞아요 — 나를 살리는 진짜 보석', note: '※ 오행 기운과 색이 통하는 보석 제안이에요. 재미로 참고하세요(효능을 단정하지 않아요).', empty: '명식을 등록하면 나에게 맞는 보석을 찾아드려요', emptyCta: '+ 명식 등록' },
  timeResolve: { yearRange: '연도를 다시 확인해 주세요(예: 1990~올해).', yearFuture: '미래 연도는 입력할 수 없어요.', removeEvent: '사건 삭제' },
  ...
  bok: { shareLead: '내 타고난 복', how: '복을 키우는 법', share: '내 복 공유하기', note: '※ 사주 십신으로 가볍게 본 타고난 복이에요. 재미로 즐겨 주세요.', detail: '내 사주 깊이 보기' },
  pastlife: { shareLead: '나의 전생', hint: '지금의 당신에게', share: '내 전생 공유하기', note: '※ 사주로 가볍게 그려 본 전생 이야기예요. 재미로 즐겨 주세요.', detail: '내 사주 깊이 보기' },
...
const en = {
  ...
  gem: { title: 'My Saju Gemstone', birthstoneTitle: 'What your birthstone means', sub: 'Your birthstone may not fit you — the gem that truly lifts you', note: '※ Gems whose element energy & color resonate with yours. For fun — no efficacy claims.', empty: 'Register a chart to find gems that fit you', emptyCta: '+ Add chart' },
  timeResolve: { yearRange: 'Please check the year again (e.g., 1990–this year).', yearFuture: 'You can’t enter a future year.', removeEvent: 'Remove event' },
...
const ja = {
  ...
  onb: {
    ...
    t1: 'AIが分析する「私」',
    b1: '八字（パルジャ）は占いアプリではありません。四柱推命をエンジンに、あなたがどんな人かを分析する自己理解ツールです。',
    t2: 'あなただけの命式を計算します',
  ...
  menu: {
    ...
    persona: '性格タイプ', personaDesc: '四柱で見る私の16タイプ', egen: 'エゲン vs テト', mbti: '四柱MBTI', selfAnalysis: '自己分析', selfAnalysisDesc: '性格·気質·五行バランスをまとめて分析', relationPattern: '関係パターン', relationPatternDesc: 'なぜ関係が繰り返すか — 生まれ持った関係の質', personal: 'パーソナル五行', personalDesc: '五行に合うカラー·コーデ·メイク·車の色', gem: '私の四柱宝石', gemDesc: '誕生石は実はあなたに合わない — あなたを活かす本当の宝石', sokgunghap: '相性(夜)', sokgunghapDesc: '二人の性的相性 (成人·遊び)', community: 'コミュニティ', communityDesc: '四柱·恋愛·悩みを分かち合う場所', joseonjob: '朝鮮時代の職業', lovestyle: '恋愛スタイル', bok: '生まれ持つ福', pastlife: '前世物語', healing: '私の癒し方',
    ...
    secFree: '今日・命式', secPremium: '自分を理解する', secContent: '人気', secSpecial: 'スペシャル', secDeep: '自分を知る', secLight: '気軽に',
  ...
  lookback: { title: '振り返り', sub2: '今日の一つを実行した日々です。', needLogin: 'ログインすると記録が保存され、ここで見返せます。', empty2: 'まだ記録がありません。今日の運勢の下の「今日の一つ」を実行してチェックしてみてください。', goToday: '今日の運勢を見る', summary: '評価した{{rated}}日のうち{{hit}}日を「当たった」とされました', summaryNote: '※ ご自身の評価なので参考程度に。外れた日こそ手がかりになります。', streak: 'これまで{{n}}日、今日の一つを実行しました', myNote: '私の記録', missionDone: '✓ その日の一つを実行しました' },
  ...
  special: { previewHead: 'こんなことが分かります', unlock: 'woonで開く', couponHint: 'woonで開けます', couponOnly: 'woonで開けます。マーケットでチャージできます。', needPay: 'woon が必要です。もう一度お試しください。', needPayMsg: 'woon が必要です。今すぐ woon で開くか、マーケットでチャージできます。', buyNow: '今すぐ購入', goMarket: 'マーケットで見る', unlockCta: '購入して見る', unlockHint: 'woonで開けます' },
  ...
  newyear: { title: '新年の運勢', generating: '今年一年を読み解いています…', heroSub: '今年一年の大きな流れをひと目で', keyword: '今年のキーワード', lucky: '今年のラッキーポイント', halves: '上半期・下半期', months: '月ごとのカレンダー', flowNote: '※ 上=上向きの月 · 下=整える月 · 数字=節気基準の月', flowNoteLow: '※ 健康は全体の流れに基づく近似です · 上=上向き · 下=整える月', samjaeAdvice: '今年とくに気をつけたいこと', resolution: '今年はこんなふうに', gateDesc: '今年のキーワードから分野ごとの運勢、12か月のカレンダー、新年の抱負まで、まとめてお届けします。', pv1: '今年のキーワード', pv2: '分野ごとの運勢8つ', pv3: '12か月のカレンダー', pv4: '上半期・下半期の流れ', pv5: '今年固めたいこと・新年の抱負', see: '新年の運勢を見る', seePaid: '新年の運勢を見る（₩9,900）', bottomNote: '※ これは今年一年の大きな流れです。毎日の運勢は「今日の運勢」でご確認ください。' },
  taegil: { title: '日取り — 良い日を探す', sub: '予定していることを選ぶと、これからの3か月のカレンダーから、あなたにぴったりの日を色で示します。', best: 'とても良い', good: '良い', tapHint: '色のついた日をタップしてみてください', note: '※ あなたに合わせたおすすめの良い日です。実際の予定はご都合に合わせてお決めください。' },  zodiac: { title: '干支・星座の今日の運勢', animal: '干支', sign: '星座', mine: 'あなたの運勢', note: '※ 気軽に楽しむ今日の運勢です。詳しい占いはマイ命式でご覧ください。' },
  ...
  assist: { title: 'ウォニ', sub: '見たいものを教えてください。そこまでご案内します。', label: 'ガイド', hello: '何をご覧になりますか？ 三つから選んでも、そのまま話しかけても大丈夫です。', egLabel: 'こんな風に言っても大丈夫', miss: 'まだその言葉は分かりませんでした。下から選んでいただければすぐご案内します。', placeholder: '何を見たいですか？', reset: '↺ 最初から', send: '送信', note: '※ ガイドはコンテンツを探す案内です。占いの内容は各コンテンツでご覧いただけます。' },
  ...
  gem: { title: '私の四柱宝石', birthstoneTitle: '誕生石にはどんな意味が', sub: '誕生石は実はあなたに合わない — あなたを活かす本当の宝石', note: '※ 五行の気と色が通じる宝石の提案です。効能は断定しません、遊びとしてご参考に。', empty: '命式を登録すると合う宝石を見つけます', emptyCta: '+ 命式登録' },
  timeResolve: { yearRange: '年をもう一度ご確認ください（例：1990〜今年）。', yearFuture: '未来の年は入力できません。', removeEvent: '出来事を削除' },
