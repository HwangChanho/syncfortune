...
const ko = {
  ...
  today: {
    dayPillar: '오늘의 일진', note: '오늘의 기운(일진)입니다. 분야 풀이는 룰 기반 무료 — 깊은 통변은 프리미엄에서.',
    areas: '분야별 풀이', area_general: '통합', area_work: '직업', area_money: '재물', area_love: '애정', area_health: '건강',
    myTg: '오늘 일진은 나의', needChart: '내 명식을 등록하면 오늘 일진이 나에게 어떤 기운인지(십신) 분야별로 풀어 드려요.', registerBtn: '명식 등록하기',
  },
...
const en = {
  ...
  today: {
    dayPillar: "Today's Day Pillar", note: "Today's energy. Area readings are rule-based & free — deep readings in Premium.",
    areas: 'Readings by area', area_general: 'Overall', area_work: 'Work', area_money: 'Wealth', area_love: 'Love', area_health: 'Health',
    myTg: "Today's pillar is my", needChart: 'Register your chart to see what today means for you (ten gods), area by area.', registerBtn: 'Register chart',
  },
...
const ja = {
  ...
  today: {
    dayPillar: '今日の日柱', note: '今日の気運です。分野別はルールベース・無料 — 深い通変はプレミアムで。',
    areas: '分野別の運勢', area_general: '総合', area_work: '仕事', area_money: '財運', area_love: '恋愛', area_health: '健康',
    myTg: '今日の日柱は私の', needChart: '命式を登録すると、今日の気運（十神）を分野別に読み解きます。', registerBtn: '命式を登録',
  },
