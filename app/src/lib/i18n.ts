...
const ja = {
  ...
  menu: {
    ...
    persona: '性格タイプ', personaDesc: '四柱で見る私の16タイプ', egen: 'エゲン vs テト', mbti: '四柱MBTI', selfAnalysis: '自己分析', selfAnalysisDesc: '性格·気質·五行バランスをまとめて分析', relationPattern: '関係パターン', relationPatternDesc: 'なぜ関係が繰り返すか — 生まれ持った関係の質', personal: 'パーソナル五行', personalDesc: '五行に合うカラー·コーデ·メイク·車の色', joseonjob: '朝鮮時代の職業', lovestyle: '恋愛スタイル', bok: '生まれ持つ福', pastlife: '前世物語', healing: '私の癒し方',
