...
export type HomeBlockKey = 'today' | 'relation' | 'persona' | 'self' | 'biorhythm' | 'luck';
...
export const DEFAULT_HOME_ORDER: HomeBlockKey[] = ['today', 'self', 'persona', 'relation', 'biorhythm', 'luck'];
