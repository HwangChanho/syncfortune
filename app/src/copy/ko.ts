...
export const ko = {
  ...
  personal: {
    'toneCap': '나의 퍼스널 컬러', title: '퍼스널 오행', sub: '내 오행에 맞는 컬러·코디·메이크업·자동차 색', activate: '나를 살리는 색', balance: '채우면 좋은 색', yongsin: ' (내게 필요한 기운)', cody: '코디', makeup: '메이크업', car: '자동차 색', empty: '명식을 등록하면 내 오행에 맞는 컬러를 찾아드려요', emptyCta: '+ 명식 등록', },
