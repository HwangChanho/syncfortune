...
export const en = {
  ...
  healing: {
    'deficit': '가장 적은 기운(참고)', shareLead: 'My healing', recharge: 'How you recharge', nourish: 'Energy to fill', release: 'Energy to release', color: 'Healing color', place: 'Healing space', food: 'Goes well with', mind: 'A word for your heart', elemLead: 'My energy', share: 'Share my healing', note: '* A gentle self-care guide from your saju elements. For mindful reference only.' },
  bio: {
    'kicker': '바이오리듬',
